...
var format_India_final_1 = new ol.format.GeoJSON();
var features_India_final_1 = format_India_final_1.readFeatures(json_India_final_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_India_final_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_India_final_1.addFeatures(features_India_final_1);
var lyr_India_final_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_India_final_1, 
                style: style_India_final_1,
                popuplayertitle: "India_final",
                interactive: true,
                title: '<img src="styles/legend/India_final_1.png" /> India_final'
            });
...
lyr_GoogleTerrainHybrid_0.setVisible(true);lyr_India_final_1.setVisible(true);lyr_Architectural3DMapping_2.setVisible(true);lyr_CityDevelopmentPlanCitySanitationPlan_3.setVisible(true);lyr_SolarEnergy_4.setVisible(true);lyr_UndergroundDrainageScheme_5.setVisible(true);lyr_HydraulicModelStudies_6.setVisible(true);lyr_DrinkingWaterSupplyWorks_7.setVisible(true);
var layersList = [lyr_GoogleTerrainHybrid_0,lyr_India_final_1,lyr_Architectural3DMapping_2,lyr_CityDevelopmentPlanCitySanitationPlan_3,lyr_SolarEnergy_4,lyr_UndergroundDrainageScheme_5,lyr_HydraulicModelStudies_6,lyr_DrinkingWaterSupplyWorks_7];
lyr_India_final_1.set('fieldAliases', {'fid': 'fid', 'cat': 'cat', 'Length': 'Length', });
...
lyr_India_final_1.set('fieldImages', {'fid': 'TextEdit', 'cat': 'TextEdit', 'Length': 'TextEdit', });
...
lyr_India_final_1.set('fieldLabels', {'fid': 'no label', 'cat': 'no label', 'Length': 'no label', });
